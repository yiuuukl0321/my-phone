      ...
      '<div class="bank-detail-scroll">' +
        ...
        '<div class="bank-card-visual checking">' +
          '<div class="bank-card-top">' +
            '<div class="bank-card-bank-name"><i class="fa-solid fa-money-bill"></i> MEH Bank</div>' +
    ...
    page.innerHTML =
      ...
      '<div class="bank-detail-scroll">' +
        ...
        '<div class="bank-card-visual saving">' +
          '<div class="bank-card-top">' +
            '<div class="bank-card-bank-name"><i class="fa-solid fa-coins"></i> MEH Bank</div>' +
